...
public class WordCupApi {
    ...
    public void WordCup(HashMap<String, Object> paramsData) {
        String testID,statusName,csvResult,message;
...
//        }
        //------------------开始请求API
        resultBody = ApiProvider.requestAppAPI(testID, dataMaps, getAccessToken(), 0);
        JSONObject jsonData = JSONObject.fromObject(resultBody);
